...
class TTSRequest(BaseModel):
    ...
    chunk_size: Optional[int] = Field(default=None, description="Chunk size for streaming synthesis: >0 splits by characters, <=0 no splitting, None uses default (5000 characters)")
