#!/usr/bin/env python3
"""
Example script for voice cloning using VoxCPM model.
This script demonstrates how to clone a voice using the /clone endpoint with VoxCPM.
Note: This assumes your API supports model selection for cloning.
"""
...
def clone_voice_voxcpm(audio_path: str, voice_name: str, transcript: str, language: str = "es"):
    """
    Clone a voice using VoxCPM model.
    ...
    print(f"Cloning voice '{voice_name}' using VoxCPM...")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Clone a voice using VoxCPM")
    ...
    clone_voice_voxcpm(args.audio, args.name, args.transcript, args.language)
